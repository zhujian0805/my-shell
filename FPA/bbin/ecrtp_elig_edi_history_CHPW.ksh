...
#*******************************************************************************
#
#  NAME:               ecrtp_elig_edi_history.ksh
#
...
#
#  BAT FILE FROM PC... wrmi32 C:\PPIC-SCRUB\edihistelig\834_09168O01_20090617703a_834_20090617.065524613 -dg C:\Diamond\PPIC\834-HIST -dt C:\Diamond\PPIC\834-HIST -n -it  -o -w -l -b -wx 1  -af C:\Diamond\output\OUTPUT.TXT C:\PPIC-SCRUB\edihistelig\output.txt -af C:\Diamond\work\WORK-HEALTH-COV-DATES C:\Diamond\work\file-1 -af C:\Diamond\work\WORK-HEALTH-COV-REF C:\Diamond\work\file-2 -af C:\Diamond\work\WORK-MEMBER-HEADER-REF C:\Diamond\work\file-3 -af C:\Diamond\work\WORK-MEMB-HEADER-DATES C:\Diamond\work\file-4
#
# SAME CMD ON UNIX:   ${rmi} "${bwd}/InputFileName -xl -dg ${bwd} -dt ${bwd} -n -it  -o -w -l -b -wx 1 -af C:\Diamond\output\OUTPUT.TXT -af C:\\Diamond\\work\\WORK-HEALTH-COV-DATES ${bwd}/file-1 -af C:\\Diamond\\work\\WORK-HEALTH-COV-REF ${bwd}/file-2 -af C:\\Diamond\\work\\WORK-MEMBER-HEADER-REF ${bwd}/file-3 -af C:\\Diamond\\work\\WORK-MEMB-HEADER-DATES ${bwd}/file-4
#
#
...
tr2="-af C:\\Diamond\\work\\WORK-HEALTH-COV-DATES ${wts_bwd}\\file-1"
tr3="-af C:\\Diamond\\work\\WORK-HEALTH-COV-REF ${wts_bwd}\\file-2"
tr4="-af C:\\Diamond\\work\\WORK-MEMBER-HEADER-REF ${wts_bwd}\\file-3"
tr5="-af C:\\Diamond\\work\\WORK-MEMB-HEADER-DATES ${wts_bwd}\\file-4"
...
####
messagelog "Command Executed: time ${mir} ${my_input} ${params} ${tr1} ${tr2} ${tr3} ${tr4} ${tr5}"
#time ${WTS_CONNECT:-OOPS} ${mir} ${wts_input} ${params} ${tr1} ${tr2} ${tr3} ${tr4} ${tr5} ${tr6} ${tr7} ${tr8} ${tr9} ${tr10} >> ${batch_log}
time ${WTS_CONNECT:-OOPS} ${mir} ${wts_input} ${params} ${tr1} ${tr2} ${tr3} ${tr4} ${tr5}
...
do
  ...
  if [[ "${xsuffix}" != "flat" && "${xprefix}" != "CHPEDIHistElig" && "${xsuffix}" != "ERROR" ]]; then
...
####
if [ ! -s ${my_output} ]; then
  batcherror_notify "ERROR -- ecrtp_elig_edi_history.ksh did not create the expected output file ${my_output}   The data was not loaded into EDIViewer.  "
fi

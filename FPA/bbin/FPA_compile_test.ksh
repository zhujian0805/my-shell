...
#*******************************************************************************
#
#  NAME:               FPA_compile_test.ksh	 
#
#  DESCRIPTION:        Shamelessly grandfathered from sql.ksh.
#
#                      This korn shell script provides automated batch 
...
#                                   files.  This FPA_compile_test.ksh routine cd's to 
...
# ----------   --------------   ------------------------------------------
# 12/15/2009   J. Thiessen      Created FPA_compile_test.ksh from sql.ksh
#
#
#*******************************************************************************
...
if [ "${#}" != "0" ]
then
  logfilename="FPA_compile_test.${1}.${2:-${ORACLE_SID:-No_Database}}.${batch_start_dtm}.log"
else
  logfilename="FPA_compile_test.ksh.${batch_start_dtm}.log"
fi
setlog "${logfilename}"
batchstart
...
usage="Usage: ${batch_prg} sql_script [ ORACLE_SID ]"
num_args=${#}
sql_parameters=""
...
--    set serveroutput on size 200000;
    @${BATCH_SYSTEM}_archive/${sql_name} ${sql_parameters}
    sho err;
    exit;
ENDSQL

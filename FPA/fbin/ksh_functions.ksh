...
# 2009-05-12   R. Crawford      Modified the Check_Log function to check for
#                               KILLED condition.
# 
#*******************************************************************************
...
####   
ck_db() {
unset return_stat return_msg my_sid my_status_file my_down_file my_up_file myline my_userpass my_ans my_count my_time
...
####
####  Examine the log file to check for "KILLED:" errors.
####  Java only change at this time - RLC 20090512
####
returnline=`grep 'KILLED:' ${batch_log}`
debug_var="--->${returnline}<---"
if [ "${returnline:-X}" != "X" ];then

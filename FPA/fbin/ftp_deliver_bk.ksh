...
#############==========================================================================================
    ...
    if [ "${my_ftpcmd}" = "End_Send" ];then leaveloop="yes"; fi;
    if [ "${my_retcod}" = "COMPLETED_FTP_CONNECTION:" ];then leaveloop="yes"; fi;
  done
...
batchstartunique    ## JPT 20050420  previously used batchstart
